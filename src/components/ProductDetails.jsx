                            ...
                            <div className="col-md-6 border-start m-auto p-3">
                                <div className="p-3 right-side">
                                    ...
                                    <div className="buttons d-flex flex-row mb-2 gap-2">
                                        <Link to="/Cart" className="btn btn-warning" onClick={() => { dispatch(addToCart(product)) 
                                      }} >Buy Now</Link>
                                        <button className="btn btn-warning" onClick={() => { dispatch(addToCart(product)) 
                                          alert('Product Added Successfully')}}><i className="fa-solid fa-cart-shopping"></i> Add to Cart</button>
                                    </div>
                                </div>
                            </div>
                        </div>
